...
namespace StereoKitDocumenter
{
	class DocMethod : IDocItem
	{
		...
		public string FileName => $"{Program.options.PagesOut}{parent.nameSpace}/{parent.Name}/{PathName}.md";
		public string UrlName  => $"{{{{site.url}}}}/Pages/{parent.nameSpace}/{parent.Name}/{PathName}.html";
