...
namespace StereoKitDocumenter
{
	class DocField : IDocItem
	{
		...
		public string FileName => $"{Program.options.PagesOut}{parent.nameSpace}/{parent.Name}/{name}.md";
		public string UrlName  => $"{{{{site.url}}}}/Pages/{parent.nameSpace}/{parent.Name}/{name}.html";
