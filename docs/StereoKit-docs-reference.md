...
> **Native code developers** can check out [this guide](https://stereokit.net/Pages/Guides/Getting-Started-Native.html) for using StereoKit from C/C++.
...
runtime is found, StereoKit will provide a [nice Simulator](https://stereokit.net/Pages/Guides/Using-The-Simulator.html)
...
Awesome! That's pretty great, but what next? [Why don't we build some UI](https://stereokit.net/Pages/Guides/User-Interface.html)?
...
does contain a [number of small demo scenes](https://stereokit.net/Pages/Guides/Sample-Code.html)
that are excellent reference for a variety of different StereoKit features!
You can also check out the [Learning Resources](https://stereokit.net/Pages/Guides/Learning-Resources.html)
...
The [regular getting started guide](https://stereokit.net/Pages/Guides/Getting-Started.html)
...
![StereoKit Ink](https://stereokit.net/img/screenshots/StereoKitInk.jpg)
...
![Bing Maps API and Terrain Sample](https://stereokit.net/img/screenshots/SKMapsTutorial.jpg)
...
### [StereoKit Demos](https://stereokit.net/Pages/Guides/Sample-Code.html)
...
![Simple UI](https://stereokit.net/img/screenshots/Guides/UIWindowSimple.jpg)
...
![Button UI](https://stereokit.net/img/screenshots/Guides/UIWindowButton.jpg)
...
![Button Image UI](https://stereokit.net/img/screenshots/Guides/UIWindowButtonImg.jpg)
...
![Toggle UI](https://stereokit.net/img/screenshots/Guides/UIWindowToggle.jpg)
...
![Custom Windows](https://stereokit.net/img/screenshots/Guides/UIWindowCustom.jpg)
...
to see the vast majority of UI elements in use, or check the [UI class docs](https://stereokit.net/Pages/StereoKit/UI.html)
...
![Explicitly sized element window](https://stereokit.net/img/screenshots/Guides/UIWindowExplicitSize.jpg)
...
![Spacing UI elements window](https://stereokit.net/img/screenshots/Guides/UIWindowSpace.jpg)
...
![Layout Cuts](https://stereokit.net/img/screenshots/Guides/UIWindowCuts.jpg)
...
![Id Conflict Avoidance](https://stereokit.net/img/screenshots/Guides/UIWindowId.jpg)
...
![Hand with joints](https://stereokit.net/img/screenshots/HandAxes.jpg)
...
![Meshes are made from triangles!](https://stereokit.net/img/screenshots/Drawing_MeshLooksLike.jpg)
...
![Combining matrices](https://stereokit.net/img/screenshots/Drawing_MatrixCombine.jpg)
...
```
![Drawing a model](https://stereokit.net/img/screenshots/Drawing_Model.jpg)
...
for more details on that, check out [the 3D Asset guide](https://stereokit.net/Guides/Working-with-3D-Assets.html)!
...
Lines.Add(
	...
	Color.Black, 1*U.cm);
```
![Drawing a line](https://stereokit.net/img/screenshots/Drawing_Lines.jpg)
...
![Drawing text](https://stereokit.net/img/screenshots/Drawing_Text.jpg)
...
the [`Sprite`](https://stereokit.net/Pages/StereoKit/Sprite.html) class!
...
```
![Drawing a sprite](https://stereokit.net/img/screenshots/Drawing_Sprite.jpg)
...
may also be interested in the [Materials guide](https://stereokit.net/Pages/Guides/Working-with-Materials.html)
...
[Material guide](https://stereokit.net/Pages/Guides/Working-with-Materials.html)!
...
```
![Working with Material copies](https://stereokit.net/img/screenshots/Materials_NewMaterial.jpg)
...
```
![Material from a Shader](https://stereokit.net/img/screenshots/Materials_ShaderMaterial.jpg)
...
![Asset Enumeration](https://stereokit.net/img/screenshots/Demos/AssetEnumeration.jpg)
...
![Controllers](https://stereokit.net/img/screenshots/Demos/Controllers.jpg)
...
![Device](https://stereokit.net/img/screenshots/Demos/Device.jpg)
...
![Eye Tracking](https://stereokit.net/img/screenshots/Demos/EyeTracking.jpg)
...
![FB Passthrough Extension](https://stereokit.net/img/screenshots/Demos/FBPassthroughExtension.jpg)
...
![Mesh Generation](https://stereokit.net/img/screenshots/Demos/MeshGeneration.jpg)
...
![Hand Sim Poses](https://stereokit.net/img/screenshots/Demos/HandSimPoses.jpg)
...
![Material Chain](https://stereokit.net/img/screenshots/Demos/MaterialChain.jpg)
...
![Math](https://stereokit.net/img/screenshots/Demos/Math.jpg)
...
![Microphone](https://stereokit.net/img/screenshots/Demos/Microphone.jpg)

## [Model Nodes](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoNodes.cs)

ModelNode API lets...

![Model Nodes](https://stereokit.net/img/screenshots/Demos/ModelNodes.jpg)

## [PBR Shaders](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoPBR.cs)

Shaders!

![PBR Shaders](https://stereokit.net/img/screenshots/Demos/PBRShaders.jpg)
...
![File Picker](https://stereokit.net/img/screenshots/Demos/FilePicker.jpg)
...
![Point Clouds](https://stereokit.net/img/screenshots/Demos/PointClouds.jpg)

## [Ray to Mesh](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoRayMesh.cs)



![Ray to Mesh](https://stereokit.net/img/screenshots/Demos/RaytoMesh.jpg)
...
![Record Mic](https://stereokit.net/img/screenshots/Demos/RecordMic.jpg)
...
![Render Scaling](https://stereokit.net/img/screenshots/Demos/RenderScaling.jpg)
...
![Procedural Textures](https://stereokit.net/img/screenshots/Demos/ProceduralTextures.jpg)

## [UI](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoUI.cs)

...

![UI](https://stereokit.net/img/screenshots/Demos/UI.jpg)
...
![UI Grab Bar](https://stereokit.net/img/screenshots/Demos/UIGrabBar.jpg)

## [UI Settings](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoUISettings.cs)



![UI Settings](https://stereokit.net/img/screenshots/Demos/UISettings.jpg)
...
![UI Tearsheet](https://stereokit.net/img/screenshots/Demos/UITearsheet.jpg)

## [Unicode Text](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoUnicode.cs)



![Unicode Text](https://stereokit.net/img/screenshots/Demos/UnicodeText.jpg)
...
![World Mesh](https://stereokit.net/img/screenshots/Demos/WorldMesh.jpg)
...
![Model with progress bar](https://stereokit.net/img/screenshots/AnimProgress.jpg)
```csharp
...
![An overly simple asset browser window](https://stereokit.net/img/screenshots/TinyAssetBrowser.jpg)
```csharp
...
![A grabbable GLTF Model using UI.Handle](https://stereokit.net/img/screenshots/HandleBox.jpg)
...
```
![FaceCull material example](https://stereokit.net/img/screenshots/MaterialCull.jpg)
...
![Default Material example](https://stereokit.net/img/screenshots/MaterialDefault.jpg)
...
```
![PBR material example](https://stereokit.net/img/screenshots/MaterialPBR.jpg)
...
```
And here's what it looks like:
![UI Material example](https://stereokit.net/img/screenshots/MaterialUI.jpg)
...
```
![UI box material example](https://stereokit.net/img/screenshots/MaterialUIBox.jpg)
...
```
![Unlit material example](https://stereokit.net/img/screenshots/MaterialUnlit.jpg)
...
![Basic text](https://stereokit.net/img/screenshots/BasicText.jpg)
...
![Two spheres, one red and one blue, both at different locations](https://stereokit.net/img/screenshots/Docs/Hierarchy_Transform.jpg)
...
![An intersecting Ray in a complicated hierarchy](https://stereokit.net/img/screenshots/Docs/Hierarchy_Spaces.jpg)
...
![Finger Glow on a Window panel](https://stereokit.net/img/screenshots/Docs/Input_FingerGlow.jpg)
...
![Identity pose at the origin](https://stereokit.net/img/screenshots/Docs/PoseIdentity.jpg)
...
![A sphere with an inverted shell outline](https://stereokit.net/img/screenshots/InvertedShell.jpg)
```csharp
...
```
![Additive transparency example](https://stereokit.net/img/screenshots/MaterialAlphaAdd.jpg)
...
```
![Alpha blend example](https://stereokit.net/img/screenshots/MaterialAlphaBlend.jpg)
...
```
![MSAA transparency example](https://stereokit.net/img/screenshots/MaterialMSAABlend.jpg)
...
![Wireframe material example](https://stereokit.net/img/screenshots/MaterialWireframe.jpg)
...
![Procedural Geometry Demo](https://stereokit.net/img/screenshots/ProceduralGeometry.jpg)
...
laid out.
![Procedural Circle Mesh](https://stereokit.net/img/screenshots/ProcGeoCircle.jpg)
```csharp
...
Here's a test image that illustrates how this mesh's geometry is
laid out.
![Procedural Cube Mesh](https://stereokit.net/img/screenshots/ProcGeoCube.jpg)
```csharp
...
Here's a test image that illustrates how this mesh's geometry is
laid out.
![Procedural Cylinder Mesh](https://stereokit.net/img/screenshots/ProcGeoCylinder.jpg)
```csharp
...
Here's a test image that illustrates how this mesh's geometry is
laid out.
![Procedural Plane Mesh](https://stereokit.net/img/screenshots/ProcGeoPlane.jpg)
```csharp
...
Here's a test image that illustrates how this mesh's geometry is
laid out.
![Procedural Rounded Cube Mesh](https://stereokit.net/img/screenshots/ProcGeoRoundedCube.jpg)
```csharp
...
Here's a test image that illustrates how this mesh's geometry is
laid out.
![Procedural Sphere Mesh](https://stereokit.net/img/screenshots/ProcGeoSphere.jpg)
```csharp
...
![Ray Mesh Intersection](https://stereokit.net/img/screenshots/RayMeshIntersect.jpg)
...
![Wavy Grid](https://stereokit.net/img/screenshots/ProceduralGrid.jpg)
...
![Microphone device selection window](https://stereokit.net/img/screenshots/MicrophoneSelector.jpg)
...
![Audio recording window](https://stereokit.net/img/screenshots/RecordAudioSnippet.jpg)
```csharp
...
![Pose direction lines](https://stereokit.net/img/screenshots/Docs/PoseDirections.jpg)
...
![Lerping between two poses](https://stereokit.net/img/screenshots/Docs/PoseLerp.jpg)

Here we construct two `Pose`s, one using a position + direction
constructor, and one using a from -> to LookAt function. Both are
valid ways of constructing a `Pose`, check out the [`Quat`](https://stereokit.net/Pages/StereoKit/Quat.html)
...
![Drawing items at a Pose](https://stereokit.net/img/screenshots/Docs/PoseDraw.jpg)
...
![UI with a custom rendererd icon](https://stereokit.net/img/screenshots/Docs/RenderListIcon.jpg)
...
```
![Generated particle sprites](https://stereokit.net/img/screenshots/TexGenParticles.jpg)
...
![Procedural Texture](https://stereokit.net/img/screenshots/ProceduralTexture.jpg)
...
![A window with labels in various states of enablement](https://stereokit.net/img/screenshots/UI/EnabledWindow.jpg)
...
![A window containing the status of a UI element](https://stereokit.net/img/screenshots/UI/LastElementAPI.jpg)
...
![A window with a button](https://stereokit.net/img/screenshots/UI/ButtonWindow.jpg)
...
![A window with text and a separator](https://stereokit.net/img/screenshots/UI/SeparatorWindow.jpg)
...
![A window with a slider](https://stereokit.net/img/screenshots/UI/SliderWindow.jpg)
...
![A window with a text input](https://stereokit.net/img/screenshots/UI/InputWindow.jpg)
...
![A window with radio buttons](https://stereokit.net/img/screenshots/UI/RadioWindow.jpg)
...
![A window with a scrolling text box](https://stereokit.net/img/screenshots/UI/TextScrollWindow.jpg)
```csharp
...
![A window with a toggle](https://stereokit.net/img/screenshots/UI/ToggleWindow.jpg)
...
![UI.InteractVolume](https://stereokit.net/img/screenshots/InteractVolume.jpg)
...
![Easing Cube](https://stereokit.net/img/screenshots/EasingCube.jpg)
```csharp
