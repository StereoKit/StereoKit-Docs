	 ...
	 pages:[
		...
		{name:'Input',
		 pages:[
			...
			{name:'HapticCaps'},
			{name:'HapticCurve'},
			{name:'HapticPreferredRate'},
			{name:'HapticPulse'},
			{name:'HapticStop'},
			{name:'HapticWaveform'},
			{name:'Key'},
			{name:'KeyboardConsume'},
			{name:'KeyboardEventAt'},
			{name:'KeyInjectPress'},
		...
		{name:'Sensor.Depth',
		 pages:[
			...
			{name:'Start'},
			{name:'Stop'},
			{name:'TryGetLatestData'},
			{name:'TryGetLatestFrame'},
		]
		},
		{name:'SensorDepthCaps'},
		{name:'SensorDepthFrame',
		 pages:[
			{name:'captureTime'},
			{name:'displayTime'},
			{name:'farZ'},
