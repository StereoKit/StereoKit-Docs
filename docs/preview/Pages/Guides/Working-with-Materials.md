...
```
![Working with Material copies]({{site.url}}/preview/img/screenshots/Materials_NewMaterial.jpg)
...
```
![Material from a Shader]({{site.url}}/preview/img/screenshots/Materials_ShaderMaterial.jpg)
