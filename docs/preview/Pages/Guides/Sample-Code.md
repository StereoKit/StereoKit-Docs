...
layout: default
title: Sample Code
description: Here are a list of small demos that illustrate how certain parts of StereoKit works!  ## [Anchors](https.//gith...
---
...
![Anchors]({{site.url}}/preview/img/screenshots/Demos/Anchors.jpg)
...
![Asset Enumeration]({{site.url}}/preview/img/screenshots/Demos/AssetEnumeration.jpg)
...
![Controllers]({{site.url}}/preview/img/screenshots/Demos/Controllers.jpg)
...
![Device]({{site.url}}/preview/img/screenshots/Demos/Device.jpg)
...
![Eye Tracking]({{site.url}}/preview/img/screenshots/Demos/EyeTracking.jpg)
...
![Mesh Generation]({{site.url}}/preview/img/screenshots/Demos/MeshGeneration.jpg)
...
![Hand Sim Poses]({{site.url}}/preview/img/screenshots/Demos/HandSimPoses.jpg)
...
![Hand Input]({{site.url}}/preview/img/screenshots/Demos/HandInput.jpg)
...
![Material Chain]({{site.url}}/preview/img/screenshots/Demos/MaterialChain.jpg)
...
![Math]({{site.url}}/preview/img/screenshots/Demos/Math.jpg)
...
![Microphone]({{site.url}}/preview/img/screenshots/Demos/Microphone.jpg)

## [Model Nodes](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoNodes.cs)

ModelNode API lets...

![Model Nodes]({{site.url}}/preview/img/screenshots/Demos/ModelNodes.jpg)
...
![Mixed Reality]({{site.url}}/preview/img/screenshots/Demos/MixedReality.jpg)

## [PBR Shaders](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoPBR.cs)

Shaders!

![PBR Shaders]({{site.url}}/preview/img/screenshots/Demos/PBRShaders.jpg)
...
![Permissions]({{site.url}}/preview/img/screenshots/Demos/Permissions.jpg)
...
![File Picker]({{site.url}}/preview/img/screenshots/Demos/FilePicker.jpg)
...
![Point Clouds]({{site.url}}/preview/img/screenshots/Demos/PointClouds.jpg)

## [Ray to Mesh](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoRayMesh.cs)



![Ray to Mesh]({{site.url}}/preview/img/screenshots/Demos/RaytoMesh.jpg)
...
![Record Mic]({{site.url}}/preview/img/screenshots/Demos/RecordMic.jpg)
...
![Render Lists]({{site.url}}/preview/img/screenshots/Demos/RenderLists.jpg)
...
![Render Scaling]({{site.url}}/preview/img/screenshots/Demos/RenderScaling.jpg)

## [Rounded UI](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoRoundedUI.cs)



![Rounded UI]({{site.url}}/preview/img/screenshots/Demos/RoundedUI.jpg)
...
![Dynamic ShadowMaps]({{site.url}}/preview/img/screenshots/Demos/DynamicShadowMaps.jpg)
...
![Procedural Textures]({{site.url}}/preview/img/screenshots/Demos/ProceduralTextures.jpg)

## [UI](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoUI.cs)

...

![UI]({{site.url}}/preview/img/screenshots/Demos/UI.jpg)
...
![UI Grab Bar]({{site.url}}/preview/img/screenshots/Demos/UIGrabBar.jpg)

## [UI Settings](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoUISettings.cs)



![UI Settings]({{site.url}}/preview/img/screenshots/Demos/UISettings.jpg)
...
![UI Tearsheet]({{site.url}}/preview/img/screenshots/Demos/UITearsheet.jpg)

## [Unicode Text](https://github.com/StereoKit/StereoKit/blob/master/Examples/StereoKitTest/Demos/DemoUnicode.cs)



![Unicode Text]({{site.url}}/preview/img/screenshots/Demos/UnicodeText.jpg)
