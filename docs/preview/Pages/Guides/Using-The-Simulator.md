...
- Left Alt - [Eye tracking]({{site.url}}/preview/Pages/Reference/Input/Eyes.html) will point along the ray indicated by the mouse.
...
to do! [`Input.HandOverride`]({{site.url}}/preview/Pages/Reference/Input/HandOverride.html)
...
or call [`Input.HandClearOverride`]({{site.url}}/preview/Pages/Reference/Input/HandClearOverride.html)
to restore control back to the user.

![An overridden hand]({{site.url}}/preview/img/screenshots/HandOverride.jpg)
