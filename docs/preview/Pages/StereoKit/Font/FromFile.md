...
---
# [Font]({{site.url}}/preview/Pages/StereoKit/Font.html).FromFile
...
|RETURNS: [Font]({{site.url}}/preview/Pages/StereoKit/Font.html)|A font from the given files, or null if all of the files failed to load properly! If any of the given files successfully loads, then this font will be a valid asset.|
