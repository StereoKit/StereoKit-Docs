---
layout: default
title: UI.PlaySoundOff
description: This will play the 'off' sound associated with the given UIVisual at the world position.
---
# [UI]({{site.url}}/preview/Pages/StereoKit/UI.html).PlaySoundOff

<div class='signature' markdown='1'>
```csharp
static void PlaySoundOff(UIVisual elementVisual, Vec3 atLocal)
```
This will play the 'off' sound associated with the given
UIVisual at the world position.
</div>
