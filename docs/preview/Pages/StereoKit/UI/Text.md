...
---
# [UI]({{site.url}}/preview/Pages/StereoKit/UI.html).Text

<div class='signature' markdown='1'>
```csharp
static void Text(string text, Align textAlign)
```
...
<div class='signature' markdown='1'>
```csharp
static void Text(string text, Align textAlign, TextFit fit, Vec2 size)
```
Displays a large chunk of text on the current layout.
This can include new lines and spaces, and will properly wrap
once it fills the entire layout! Text uses the UI's current font
...
<div class='signature' markdown='1'>
```csharp
static bool Text(string text, Vec2& scroll, UIScroll scrollDirection, Vec2 size, Align textAlign, TextFit fit)
```
...
<div class='signature' markdown='1'>
```csharp
static bool Text(string text, Vec2& scroll, UIScroll scrollDirection, float height, Align textAlign, TextFit fit)
```
A scrolling text element! This is for reading large chunks
of text that may be too long to fit in the available space. It
...
![A window with text and a separator]({{site.url}}/preview/img/screenshots/UI/SeparatorWindow.jpg)
...
![A window with a scrolling text box]({{site.url}}/preview/img/screenshots/UI/TextScrollWindow.jpg)
```csharp
