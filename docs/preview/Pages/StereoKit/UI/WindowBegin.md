...
description: Begins a new window! This will push an automatically determined pose onto the transform stack, and all UI elements will be relative to that new pose. The pose is actually the top-center of the window. Must be finished with a call to UI.WindowEnd().
---
# [UI]({{site.url}}/preview/Pages/StereoKit/UI.html).WindowBegin

<div class='signature' markdown='1'>
```csharp
static void WindowBegin(string text, UIWin windowType, UIMove moveType)
```
Begins a new window! This will push an automatically
...
<div class='signature' markdown='1'>
```csharp
static void WindowBegin(string text, Vec2 size, UIWin windowType, UIMove moveType)
```
Begins a new window! This will push an automatically
determined pose onto the transform stack, and all UI elements will
be relative to that new pose. The pose is actually the top-center
