...
---
# [UI]({{site.url}}/preview/Pages/StereoKit/UI.html).HSlider
...
|[UINotify]({{site.url}}/preview/Pages/StereoKit/UINotify.html) notifyOn|Allows you to modify the behavior of the             return value.|
...
![A window with a slider]({{site.url}}/preview/img/screenshots/UI/SliderWindow.jpg)
