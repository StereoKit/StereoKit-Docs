...
---
# [UI]({{site.url}}/preview/Pages/StereoKit/UI.html).StackHash
...
|RETURNS: [IdHash]({{site.url}}/preview/Pages/StereoKit/IdHash.html)|An integer based hash id for use with SK UI.|
