...
---
# [Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html).LookAt
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) from|Starting location.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) at|Lookat location.|
|RETURNS: [Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html)|A pose at position `from`, oriented to look towards `at`.|
