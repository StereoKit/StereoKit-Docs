...
---
# [Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html).Implicit Conversions
...
|RETURNS: [Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html)|A StereoKit compatible vector.|
...
|  |  |
|--|--|
|[Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html) v|Any StereoKit.Vec2.|
