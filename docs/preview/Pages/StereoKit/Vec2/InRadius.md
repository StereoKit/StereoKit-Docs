...
---
# [Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html).InRadius
...
|  |  |
|--|--|
|[Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html) pt|The point to check against.|
...
|  |  |
|--|--|
|[Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html) a|The first point.|
|[Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html) b|And the second point!|
|float radius|The distance to check against.|
