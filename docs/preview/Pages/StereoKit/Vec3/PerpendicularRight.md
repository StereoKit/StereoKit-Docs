...
---
# [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html).PerpendicularRight
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) forward|What way are you facing?|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) up|What direction is up?|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|Your direction to the right! Result is -not- a unit vector, even if both 'forward' and 'up' are unit vectors.|
