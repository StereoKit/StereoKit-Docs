...
---
# [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html).InRadius
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) pt|The point to check against.|
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) a|The first point.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) b|And the second point!|
|float radius|The distance to check against.|
