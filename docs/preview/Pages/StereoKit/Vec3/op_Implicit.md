...
---
# [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html).Implicit Conversions
...
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|A StereoKit compatible vector.|
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) v|Any StereoKit.Vec3.|
