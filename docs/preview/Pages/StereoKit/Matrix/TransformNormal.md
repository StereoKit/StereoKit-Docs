...
---
# [Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html).TransformNormal
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) normal|The direction to transform.|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The direction transformed by the Matrix.|
