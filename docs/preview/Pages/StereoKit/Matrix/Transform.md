...
---
# [Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html).Transform
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) point|The point to transform.|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The point transformed by the Matrix.|
...
|  |  |
|--|--|
|[Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html) pose|The original pose.|
|RETURNS: [Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html)|The transformed pose.|
