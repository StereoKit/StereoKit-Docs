...
|  |  |
|--|--|
|[Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html) a|First Matrix.|
|[Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html) b|Second Matrix.|
|RETURNS: [Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html)|Result of matrix multiplication.|
...
|  |  |
|--|--|
|[Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html) a|A transform matrix.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) b|Any Vector.|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The Vec3 transformed by the matrix, including translation.|
...
|--|--|
|[Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html) a|A transform matrix.|
|[Ray]({{site.url}}/preview/Pages/StereoKit/Ray.html) b|A Ray to be transformed.|
|RETURNS: [Ray]({{site.url}}/preview/Pages/StereoKit/Ray.html)|A Ray transformed by the Matrix.|
...
|--|--|
|[Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html) a|A transform matrix.|
|[Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html) b|A Pose to be transformed.|
|RETURNS: [Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html)|A Ray transformed by the Matrix.|
