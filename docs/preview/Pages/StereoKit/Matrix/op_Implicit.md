...
---
# [Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html).Implicit Conversions
...
|RETURNS: [Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html)|A StereoKit compatible matrix.|
...
|  |  |
|--|--|
|[Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html) m|Any StereoKit.Matrix.|
