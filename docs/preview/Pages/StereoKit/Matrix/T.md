...
---
# [Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html).T
...
|RETURNS: [Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html)|A Matrix containing a simple translation!|
