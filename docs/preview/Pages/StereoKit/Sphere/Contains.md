...
---
# [Sphere]({{site.url}}/preview/Pages/StereoKit/Sphere.html).Contains
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) point|A point in the same coordinate space as this sphere.|
