...
---
# [SphericalHarmonics]({{site.url}}/preview/Pages/StereoKit/SphericalHarmonics.html).FromLights
...
|RETURNS: [SphericalHarmonics]({{site.url}}/preview/Pages/StereoKit/SphericalHarmonics.html)|A SphericalHarmonics approximation of the irradiance given from a set of directional lights!|
