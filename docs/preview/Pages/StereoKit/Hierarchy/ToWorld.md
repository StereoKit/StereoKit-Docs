...
---
# [Hierarchy]({{site.url}}/preview/Pages/StereoKit/Hierarchy.html).ToWorld
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) localPoint|A point in local space.|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The provided point now in world space!|
...
|  |  |
|--|--|
|[Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html) localOrientation|A rotation in local space.|
|RETURNS: [Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html)|The provided rotation now in world space!|
...
|  |  |
|--|--|
|[Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html) localPose|A pose in local space.|
|RETURNS: [Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html)|The provided pose now in world space!|
...
|  |  |
|--|--|
|[Ray]({{site.url}}/preview/Pages/StereoKit/Ray.html) localRay|A ray in local space.|
|RETURNS: [Ray]({{site.url}}/preview/Pages/StereoKit/Ray.html)|The provided ray now in world space!|
