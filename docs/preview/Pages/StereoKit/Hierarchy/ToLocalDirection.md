...
---
# [Hierarchy]({{site.url}}/preview/Pages/StereoKit/Hierarchy.html).ToLocalDirection
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) worldDirection|A direction in world space.|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The provided direction now in local hierarchy space!|
