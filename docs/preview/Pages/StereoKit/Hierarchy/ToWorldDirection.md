...
---
# [Hierarchy]({{site.url}}/preview/Pages/StereoKit/Hierarchy.html).ToWorldDirection
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) localDirection|A direction in local space.|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The provided direction now in world space!|
