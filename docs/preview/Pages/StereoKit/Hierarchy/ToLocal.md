...
---
# [Hierarchy]({{site.url}}/preview/Pages/StereoKit/Hierarchy.html).ToLocal
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) worldPoint|A point in world space.|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The provided point now in local hierarchy space!|
...
|  |  |
|--|--|
|[Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html) worldOrientation|A rotation in world space.|
|RETURNS: [Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html)|The provided rotation now in local hierarchy space!|
...
|  |  |
|--|--|
|[Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html) worldPose|A pose in world space.|
|RETURNS: [Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html)|The provided pose now in local hierarchy space!|
...
|  |  |
|--|--|
|[Ray]({{site.url}}/preview/Pages/StereoKit/Ray.html) worldRay|A ray in world space.|
|RETURNS: [Ray]({{site.url}}/preview/Pages/StereoKit/Ray.html)|The provided ray now in local hierarchy space!|
