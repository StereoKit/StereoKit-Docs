...
|  |  |
|--|--|
|float [Duration]({{site.url}}/preview/Pages/StereoKit/Anim/Duration.html)|The duration of the animation at normal playback speed, in seconds.|
|string [Name]({{site.url}}/preview/Pages/StereoKit/Anim/Name.html)|The name of the animation as provided by the original asset.|
