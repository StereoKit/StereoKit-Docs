...
---
# [Input]({{site.url}}/preview/Pages/StereoKit/Input.html).HandClearOverride
...
|  |  |
|--|--|
|[Handed]({{site.url}}/preview/Pages/StereoKit/Handed.html) hand|Which hand are we clearing the override on?|
