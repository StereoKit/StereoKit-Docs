---
layout: default
title: Input.HapticStop
description: Cancels any haptic playback on the given output, including in-flight PCM streams.
---
# [Input]({{site.url}}/preview/Pages/StereoKit/Input.html).HapticStop

<div class='signature' markdown='1'>
```csharp
static void HapticStop(InputHaptic output)
```
Cancels any haptic playback on the given output, including
in-flight PCM streams.
</div>

|  |  |
|--|--|
|[InputHaptic]({{site.url}}/preview/Pages/StereoKit/InputHaptic.html) output|Which haptic output to silence.|
