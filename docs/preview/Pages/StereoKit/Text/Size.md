...
---
# [Text]({{site.url}}/preview/Pages/StereoKit/Text.html).Size
...
|RETURNS: [Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html)|The size that this text will take up, in meters! Width will be the same as maxWidth as long as the text takes more than one line, and height will be the total height of the text.|
