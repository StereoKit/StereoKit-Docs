...
|  |  |
|--|--|
|int [CursorSamples]({{site.url}}/preview/Pages/StereoKit/Sound/CursorSamples.html)|This is the current position of the playback cursor, measured in samples from the start of the audio data.|
...
|int [TotalSamples]({{site.url}}/preview/Pages/StereoKit/Sound/TotalSamples.html)|This will return the total number of audio samples used by the sound! StereoKit currently uses 48,000 samples per second for all audio.|
...
|[FromFile]({{site.url}}/preview/Pages/StereoKit/Sound/FromFile.html)|Loads a sound effect from file! Currently, StereoKit supports .wav and .mp3 files. Audio is converted to mono.|
