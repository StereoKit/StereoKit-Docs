...
---
# [IdHash]({{site.url}}/preview/Pages/StereoKit/IdHash.html).Implicit Conversions
...
|  |  |
|--|--|
|[IdHash]({{site.url}}/preview/Pages/StereoKit/IdHash.html) h|Source id.|
...
|--|--|
|UInt64 h|Source id.|
|RETURNS: [IdHash]({{site.url}}/preview/Pages/StereoKit/IdHash.html)|A new style IdHash hash.|
