...
---
# [Default]({{site.url}}/preview/Pages/StereoKit/Default.html).MaterialUIBox

<div class='signature' markdown='1'>
static [Material]({{site.url}}/preview/Pages/StereoKit/Material.html) MaterialUIBox{ get set }
</div>
...
```
![UI box material example]({{site.url}}/preview/img/screenshots/MaterialUIBox.jpg)
