...
---
# [Default]({{site.url}}/preview/Pages/StereoKit/Default.html).MaterialUI

<div class='signature' markdown='1'>
static [Material]({{site.url}}/preview/Pages/StereoKit/Material.html) MaterialUI{ get set }
</div>
...
![UI Material example]({{site.url}}/preview/img/screenshots/MaterialUI.jpg)
