...
---
# [Default]({{site.url}}/preview/Pages/StereoKit/Default.html).MaterialUnlit

<div class='signature' markdown='1'>
static [Material]({{site.url}}/preview/Pages/StereoKit/Material.html) MaterialUnlit{ get set }
</div>
...
```
![Unlit material example]({{site.url}}/preview/img/screenshots/MaterialUnlit.jpg)
