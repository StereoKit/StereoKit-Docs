...
---
# [Default]({{site.url}}/preview/Pages/StereoKit/Default.html).MaterialPBR

<div class='signature' markdown='1'>
static [Material]({{site.url}}/preview/Pages/StereoKit/Material.html) MaterialPBR{ get set }
</div>
...
```
![PBR material example]({{site.url}}/preview/img/screenshots/MaterialPBR.jpg)
