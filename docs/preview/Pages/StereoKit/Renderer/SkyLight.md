...
---
# [Renderer]({{site.url}}/preview/Pages/StereoKit/Renderer.html).SkyLight

<div class='signature' markdown='1'>
static [SphericalHarmonics]({{site.url}}/preview/Pages/StereoKit/SphericalHarmonics.html) SkyLight{ get set }
</div>
...
![Default Material example]({{site.url}}/preview/img/screenshots/MaterialDefault.jpg)
