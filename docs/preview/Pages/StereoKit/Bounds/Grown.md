...
---
# [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html).Grown
...
|  |  |
|--|--|
|[Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html) box|The box to encapsulate!|
|RETURNS: [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html)|The bounds that also encapsulate the provided box.|
