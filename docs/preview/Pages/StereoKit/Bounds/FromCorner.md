...
---
# [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html).FromCorner
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) bottomLeftBack|The -X,-Y,-Z corner of the box.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) dimensions|The total dimensions of the box.|
|RETURNS: [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html)|A Bounds object that extends from bottomLeftBack to bottomLeftBack+dimensions.|
