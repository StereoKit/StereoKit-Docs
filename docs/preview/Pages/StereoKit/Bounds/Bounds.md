...
---
# [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html).Bounds
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) center|The exact center of the box.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) totalDimensions|The total size of the box, from one             end to the other. This is the width, height, and depth of the             Bounds.|
