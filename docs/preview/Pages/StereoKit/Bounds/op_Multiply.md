...
---
# [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html).*
...
|  |  |
|--|--|
|[Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html) a|The source Bounds.|
|float b|A scalar multiplier for the Bounds.|
|RETURNS: [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html)|A new Bounds that has been scaled.|
...
|--|--|
|[Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html) a|The source Bounds.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) b|A Vec3 multiplier for the Bounds.|
|RETURNS: [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html)|A new Bounds that has been scaled.|
