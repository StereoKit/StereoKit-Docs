...
---
# [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html).FromCorners
...
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) topRightFront|The +X,+Y,+Z corner of the box.|
|RETURNS: [Bounds]({{site.url}}/preview/Pages/StereoKit/Bounds.html)|A Bounds object that extends from bottomLeftBack to topRightFront.|
