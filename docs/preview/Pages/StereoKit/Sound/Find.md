...
---
# [Sound]({{site.url}}/preview/Pages/StereoKit/Sound.html).Find
...
|RETURNS: [Sound]({{site.url}}/preview/Pages/StereoKit/Sound.html)|A link to the sound matching 'soundId', null if none is found.|
