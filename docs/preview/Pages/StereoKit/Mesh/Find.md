...
---
# [Mesh]({{site.url}}/preview/Pages/StereoKit/Mesh.html).Find
...
|RETURNS: [Mesh]({{site.url}}/preview/Pages/StereoKit/Mesh.html)|A Mesh with a matching id, or null if none is found.|
