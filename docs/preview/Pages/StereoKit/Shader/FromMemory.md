...
---
# [Shader]({{site.url}}/preview/Pages/StereoKit/Shader.html).FromMemory
...
|RETURNS: [Shader]({{site.url}}/preview/Pages/StereoKit/Shader.html)|A shader from the given data, or null if it failed to load/compile.|
