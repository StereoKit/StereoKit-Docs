...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).SetVector
...
|[Vec4]({{site.url}}/preview/Pages/StereoKit/Vec4.html) value|New value for the parameter.|
...
|--|--|
|string name|Name of the shader parameter.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) value|New value for the parameter.|
...
|--|--|
|string name|Name of the shader parameter.|
|[Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html) value|New value for the parameter.|
