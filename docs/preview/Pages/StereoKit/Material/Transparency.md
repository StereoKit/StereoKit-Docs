...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).Transparency

<div class='signature' markdown='1'>
[Transparency]({{site.url}}/preview/Pages/StereoKit/Transparency.html) Transparency{ get set }
</div>
...
```
![Additive transparency example]({{site.url}}/preview/img/screenshots/MaterialAlphaAdd.jpg)
### Alpha Blending
...
```
![Alpha blend example]({{site.url}}/preview/img/screenshots/MaterialAlphaBlend.jpg)
...
```
![MSAA transparency example]({{site.url}}/preview/img/screenshots/MaterialMSAABlend.jpg)
