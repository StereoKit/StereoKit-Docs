...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).GetColor
...
|RETURNS: [Color]({{site.url}}/preview/Pages/StereoKit/Color.html)|The parameter's value, if present, otherwise Color.White.|
