...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).GetTexture
...
|RETURNS: [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html)|The parameter's value, if present, otherwise null.|
