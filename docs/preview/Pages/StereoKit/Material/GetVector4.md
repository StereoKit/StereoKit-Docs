...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).GetVector4
...
|RETURNS: [Vec4]({{site.url}}/preview/Pages/StereoKit/Vec4.html)|The parameter's value, if present, otherwise Vec4.Zero.|
