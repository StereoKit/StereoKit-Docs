...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).Chain

<div class='signature' markdown='1'>
[Material]({{site.url}}/preview/Pages/StereoKit/Material.html) Chain{ get set }
</div>
...
![A sphere with an inverted shell outline]({{site.url}}/preview/img/screenshots/InvertedShell.jpg)
```csharp
