...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).Copy
...
|  |  |
|--|--|
|RETURNS: [Material]({{site.url}}/preview/Pages/StereoKit/Material.html)|A new Material asset with the same shader and properties.|
...
|RETURNS: [Material]({{site.url}}/preview/Pages/StereoKit/Material.html)|A new Material asset with the same shader and properties. Returns null if no materials are found with the given id.|
