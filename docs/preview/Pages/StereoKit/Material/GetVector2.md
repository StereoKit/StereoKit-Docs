...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).GetVector2
...
|RETURNS: [Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html)|The parameter's value, if present, otherwise Vec2.Zero.|
