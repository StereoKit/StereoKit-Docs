...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).Find
...
|RETURNS: [Material]({{site.url}}/preview/Pages/StereoKit/Material.html)|A link to the Material matching 'id', null if none is found.|
