...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).GetMatrix
...
|RETURNS: [Matrix]({{site.url}}/preview/Pages/StereoKit/Matrix.html)|The parameter's value, if present, otherwise Matrix.Identity.|
