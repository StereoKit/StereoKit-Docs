...
---
# [Material]({{site.url}}/preview/Pages/StereoKit/Material.html).GetVector3
...
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The parameter's value, if present, otherwise Vec3.Zero.|
