...
---
# [Sprite]({{site.url}}/preview/Pages/StereoKit/Sprite.html).Find
...
|RETURNS: [Sprite]({{site.url}}/preview/Pages/StereoKit/Sprite.html)|A Sprite asset with the given id, or null if none is found.|
