...
---
# [Sprite]({{site.url}}/preview/Pages/StereoKit/Sprite.html).FromFile
...
|RETURNS: [Sprite]({{site.url}}/preview/Pages/StereoKit/Sprite.html)|A Sprite asset, or null if the image failed to load!|
