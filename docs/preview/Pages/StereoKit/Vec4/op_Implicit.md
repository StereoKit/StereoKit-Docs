...
---
# [Vec4]({{site.url}}/preview/Pages/StereoKit/Vec4.html).Implicit Conversions
...
|RETURNS: [Vec4]({{site.url}}/preview/Pages/StereoKit/Vec4.html)|A StereoKit compatible vector.|
...
|  |  |
|--|--|
|[Vec4]({{site.url}}/preview/Pages/StereoKit/Vec4.html) v|Any StereoKit.Vec4.|
