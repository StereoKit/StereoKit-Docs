...
---
# [Vec4]({{site.url}}/preview/Pages/StereoKit/Vec4.html).Vec4
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) xyz|X, Y and Z components of the vector.|
|float w|W component of the vector.|
...
|  |  |
|--|--|
|[Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html) xy|X and Y components of the vector.|
|[Vec2]({{site.url}}/preview/Pages/StereoKit/Vec2.html) zw|Z and W components of the vector.|
