...
---
# [Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html).Delta
...
|  |  |
|--|--|
|[Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html) from|The origin rotation.|
|[Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html) to|And the target rotation!|
|RETURNS: [Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html)|The quaternion between from and to.|
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) from|The origin direction.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) to|And the target direction!|
|RETURNS: [Quat]({{site.url}}/preview/Pages/StereoKit/Quat.html)|The quaternion between from and to.|
