...
---
# [Plane]({{site.url}}/preview/Pages/StereoKit/Plane.html).Intersect
...
|  |  |
|--|--|
|[Ray]({{site.url}}/preview/Pages/StereoKit/Ray.html) ray|Ray we're checking with.|
...
|  |  |
|--|--|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) lineStart|Start of the line.|
|[Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html) lineEnd|End of the line.|
|Vec3& at|An out parameter that will hold the intersection             point. If there's no intersection, this will be (0,0,0).|
|RETURNS: bool|True if there's an intersection, false if not. Refer to the 'at' parameter for intersection information!|
