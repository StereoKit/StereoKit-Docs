...
---
# [MaterialBuffer]({{site.url}}/preview/Pages/StereoKit/MaterialBuffer.html).MaterialBuffer
...
void MaterialBuffer()
```
Create a new global MaterialBuffer that can be bound to a
register slot id via Renderer.SetGlobalBuffer. All shaders will
have access to the data provided via this instance's `Set`.
</div>
