...
|  |  |
|--|--|
|[LogLevel]({{site.url}}/preview/Pages/StereoKit/LogLevel.html) [Filter]({{site.url}}/preview/Pages/StereoKit/Log/Filter.html)|What's the lowest level of severity logs to display on the console? Default is LogLevel.Info.|

## Static Methods

|  |  |
|--|--|
|[Diag]({{site.url}}/preview/Pages/StereoKit/Log/Diag.html)|Writes a formatted line to the log using a LogLevel.Diagnostic severity level!|
|[Err]({{site.url}}/preview/Pages/StereoKit/Log/Err.html)|Writes a formatted line to the log using a LogLevel.Error severity level!|
|[Info]({{site.url}}/preview/Pages/StereoKit/Log/Info.html)|Writes a formatted line to the log using a LogLevel.Info severity level!|
|[Subscribe]({{site.url}}/preview/Pages/StereoKit/Log/Subscribe.html)|Allows you to listen in on log events! Any callback subscribed here will be called when something is logged. This does honor the Log.Filter, so filtered logs will not be received here.|
|[Unsubscribe]({{site.url}}/preview/Pages/StereoKit/Log/Unsubscribe.html)|If you subscribed to the log callback, you can unsubscribe that callback here!|
|[Warn]({{site.url}}/preview/Pages/StereoKit/Log/Warn.html)|Writes a formatted line to the log using a LogLevel.Warn severity level!|
|[Write]({{site.url}}/preview/Pages/StereoKit/Log/Write.html)|Writes a formatted line to the log with the specified severity level!|
