...
|  |  |
|--|--|
|string [Id]({{site.url}}/preview/Pages/StereoKit/MaterialBuffer/Id.html)|Gets or sets the unique identifier of this asset resource! This can be helpful for debugging, managing your assets, or finding them later on!|

## Instance Methods

|  |  |
|--|--|
|[MaterialBuffer]({{site.url}}/preview/Pages/StereoKit/MaterialBuffer/MaterialBuffer.html)|Create a new global MaterialBuffer bound to the register slot id. All shaders will have access to the data provided via this instance's `Set`.|
|[Set]({{site.url}}/preview/Pages/StereoKit/MaterialBuffer/Set.html)|This will upload your data to the GPU for shaders to use.|
