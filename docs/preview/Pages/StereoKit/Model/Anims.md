...
layout: default
title: Model.Anims
description: An enumerable collection of animations attached to this Model. You can do Linq stuff with it, foreach it, or just treat it like a List or array! Accessing Count or iterating will block until the Model has fully finished loading.
---
# [Model]({{site.url}}/preview/Pages/StereoKit/Model.html).Anims

<div class='signature' markdown='1'>
[ModelAnimCollection]({{site.url}}/preview/Pages/StereoKit/ModelAnimCollection.html) Anims{ get }
</div>
...
the Model has fully finished loading.
