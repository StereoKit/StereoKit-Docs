...
---
# [Model]({{site.url}}/preview/Pages/StereoKit/Model.html).FromMesh
...
|  |  |
|--|--|
|[Mesh]({{site.url}}/preview/Pages/StereoKit/Mesh.html) mesh|Any Mesh asset.|
|[Material]({{site.url}}/preview/Pages/StereoKit/Material.html) material|Any Material asset.|
|RETURNS: [Model]({{site.url}}/preview/Pages/StereoKit/Model.html)|A Model composed of a single mesh and Material.|
