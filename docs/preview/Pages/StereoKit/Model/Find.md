...
---
# [Model]({{site.url}}/preview/Pages/StereoKit/Model.html).Find
...
|RETURNS: [Model]({{site.url}}/preview/Pages/StereoKit/Model.html)|A link to the Model matching 'modelId', null if none is found.|
