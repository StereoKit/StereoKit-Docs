...
description: Searches the list of animations for the first one matching the given name. This will block until the Model has fully finished loading.
---
# [Model]({{site.url}}/preview/Pages/StereoKit/Model.html).FindAnim
...
|RETURNS: [Anim]({{site.url}}/preview/Pages/StereoKit/Anim.html)|A link to the animation, or null if none is found.|
