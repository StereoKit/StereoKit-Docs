...
---
# [Model]({{site.url}}/preview/Pages/StereoKit/Model.html).PlayAnim
...
|[AnimMode]({{site.url}}/preview/Pages/StereoKit/AnimMode.html) mode|The mode with which to play the animation.|
...
|  |  |
|--|--|
|[Anim]({{site.url}}/preview/Pages/StereoKit/Anim.html) animation|The new active animation.|
|[AnimMode]({{site.url}}/preview/Pages/StereoKit/AnimMode.html) mode|The mode with which to play the animation.|
