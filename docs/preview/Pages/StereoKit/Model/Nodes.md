...
layout: default
title: Model.Nodes
description: This is an enumerable collection of all the nodes in this Model, ordered non-hierarchically by when they were added. You can do Linq stuff with it, foreach it, or just treat it like a List or array! Accessing Count or iterating will block until the Model's metadata has finished loading.
---
# [Model]({{site.url}}/preview/Pages/StereoKit/Model.html).Nodes

<div class='signature' markdown='1'>
[ModelNodeCollection]({{site.url}}/preview/Pages/StereoKit/ModelNodeCollection.html) Nodes{ get }
</div>
