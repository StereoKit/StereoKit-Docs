...
---
# [Color]({{site.url}}/preview/Pages/StereoKit/Color.html).*
...
|  |  |
|--|--|
|[Color]({{site.url}}/preview/Pages/StereoKit/Color.html) a|The source color.|
|float b|The float to multiply by.|
|RETURNS: [Color]({{site.url}}/preview/Pages/StereoKit/Color.html)|A multiplied color.|
...
|  |  |
|--|--|
|[Color]({{site.url}}/preview/Pages/StereoKit/Color.html) a|The first color.|
|[Color]({{site.url}}/preview/Pages/StereoKit/Color.html) b|The second color.|
|RETURNS: [Color]({{site.url}}/preview/Pages/StereoKit/Color.html)|A multiplied color.|
