...
---
# [Color]({{site.url}}/preview/Pages/StereoKit/Color.html).Implicit Conversions
...
|  |  |
|--|--|
|[Color]({{site.url}}/preview/Pages/StereoKit/Color.html) c|A 128 bit color to crush down.|
|RETURNS: [Color32]({{site.url}}/preview/Pages/StereoKit/Color32.html)|A crushed down color.|
