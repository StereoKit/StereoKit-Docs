...
---
# [Color]({{site.url}}/preview/Pages/StereoKit/Color.html).HSV
...
|RETURNS: [Color]({{site.url}}/preview/Pages/StereoKit/Color.html)|A gamma space RGB color!|
