...
---
# [Color]({{site.url}}/preview/Pages/StereoKit/Color.html).ToHSV
...
|  |  |
|--|--|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|Hue, Saturation, and Value, stored in x, y, and z respectively. All values are between 0-1.|
