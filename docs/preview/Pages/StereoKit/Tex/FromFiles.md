...
---
# [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html).FromFiles
...
|RETURNS: [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html)|A Tex asset from the given files, or null if it failed to load.|
