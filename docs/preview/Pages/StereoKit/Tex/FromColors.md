...
---
# [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html).FromColors
...
|RETURNS: [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html)|A Tex asset with TexType.Image and TexFormat.Rgba32 from the given array of colors.|
