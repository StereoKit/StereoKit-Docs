...
---
# [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html).FromMemory
...
|RETURNS: [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html)|A Tex asset from the given file, or null if it failed to load.|
