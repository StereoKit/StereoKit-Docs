...
---
# [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html).SetNativeSurface
...
|[TexType]({{site.url}}/preview/Pages/StereoKit/TexType.html) type|The image flags that tell SK how to treat the             texture, this should match up with the settings the texture was             originally created with. If SK can figure the appropriate settings,             it _may_ override the value provided here.|
