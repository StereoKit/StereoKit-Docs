...
---
# [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html).Find
...
|RETURNS: [Tex]({{site.url}}/preview/Pages/StereoKit/Tex.html)|A Tex asset with the given id, or null if none is found.|
