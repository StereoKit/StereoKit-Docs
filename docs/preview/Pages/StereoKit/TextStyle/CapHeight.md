---
layout: default
title: TextStyle.CapHeight
description: (meters) The height of a standard captial letter, such as 'H' or 'T'.
---
# [TextStyle]({{site.url}}/preview/Pages/StereoKit/TextStyle.html).CapHeight
...
## Description
(meters) The height of a standard captial letter, such as
'H' or 'T'.
