...
---
# [EasePose]({{site.url}}/preview/Pages/StereoKit.Framework/EasePose.html).Resolve
...
|  |  |
|--|--|
|RETURNS: [Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html)|The current easing value.|
