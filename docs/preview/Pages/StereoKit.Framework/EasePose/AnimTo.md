...
---
# [EasePose]({{site.url}}/preview/Pages/StereoKit.Framework/EasePose.html).AnimTo

<div class='signature' markdown='1'>
```csharp
void AnimTo(Pose destination, float duration, EaseFn easeFn)
```
...
|  |  |
|--|--|
|[Pose]({{site.url}}/preview/Pages/StereoKit/Pose.html) destination|This is the final state for the value when the easing animation has finished.|
