...
---
# [EaseColor]({{site.url}}/preview/Pages/StereoKit.Framework/EaseColor.html).Resolve
...
|  |  |
|--|--|
|RETURNS: [Color]({{site.url}}/preview/Pages/StereoKit/Color.html)|The current easing value.|
