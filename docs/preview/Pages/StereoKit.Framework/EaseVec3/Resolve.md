...
---
# [EaseVec3]({{site.url}}/preview/Pages/StereoKit.Framework/EaseVec3.html).Resolve
...
|  |  |
|--|--|
|RETURNS: [Vec3]({{site.url}}/preview/Pages/StereoKit/Vec3.html)|The current easing value.|
