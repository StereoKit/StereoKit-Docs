...
|  |  |
|--|--|
|[FastIn]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/FastIn.html)|Quartic soft start with a hard stop.|
|[FastInOut]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/FastInOut.html)|Quartic smooth start, fast middle, and smooth stop.|
|[FastOut]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/FastOut.html)|Quartic fast start with a soft stop, a pretty good default for most cases as it feels very responsive and looks good.|
|[Linear]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/Linear.html)|A constant motion the whole way through. Stops and starts hard, doesn't look all that great in most cases.|
|[OvershootIn]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/OvershootIn.html)|Soft start with a hard stop, overshoots its destination a bit before arriving at it.|
|[OvershootInOut]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/OvershootInOut.html)|Smooth start, fast middle, and smooth stop. Overshoots on both the start and the end.|
|[OvershootOut]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/OvershootOut.html)|Fast start with a soft stop, backs off a bit before moving to its destination.|
|[SoftIn]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/SoftIn.html)|Quadratic soft start with a hard stop.|
|[SoftInOut]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/SoftInOut.html)|Quadratic smooth start, fast middle, and smooth stop.|
|[SoftOut]({{site.url}}/preview/Pages/StereoKit.Framework/Ease/SoftOut.html)|Quadratic fast start with a soft stop, a very good default for most cases as it feels very responsive and looks good.|
...
![Easing Cube]({{site.url}}/preview/img/screenshots/EasingCube.jpg)
```csharp
