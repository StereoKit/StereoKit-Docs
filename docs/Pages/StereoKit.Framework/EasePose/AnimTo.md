...
---
# [EasePose]({{site.url}}/Pages/StereoKit.Framework/EasePose.html).AnimTo
...
|  |  |
|--|--|
|[Pose]({{site.url}}/Pages/StereoKit/Pose.html) destination|This is the final state for the value             when the easing animation has finished.|
