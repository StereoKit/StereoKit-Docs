...
---
# [Input]({{site.url}}/Pages/StereoKit/Input.html).Controller
...
|  |  |
|--|--|
|[Handed]({{site.url}}/Pages/StereoKit/Handed.html) handed|The handedness of the controller to get the             state of.|
|RETURNS: [Controller]({{site.url}}/Pages/StereoKit/Controller.html)|A reference to a class that contains state information about the indicated controller.|
