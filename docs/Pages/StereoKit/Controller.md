...
|[Pose]({{site.url}}/Pages/StereoKit/Pose.html) [pose]({{site.url}}/Pages/StereoKit/Controller/pose.html)|The grip pose of the controller. This approximately represents the center of the hand's position. Check `trackedPos` and `trackedRot` for the current state of the pose data.|
