...
|  |  |
|--|--|
|[Material]({{site.url}}/Pages/StereoKit/Material/Material.html)|Creates a material from a shader, and uses the shader's default settings. Uses an auto-generated id.|
