...
---
# [Matrix]({{site.url}}/Pages/StereoKit/Matrix.html).R
...
|RETURNS: [Matrix]({{site.url}}/Pages/StereoKit/Matrix.html)|A Matrix that will rotate by the provided Quaternion orientation.|
...
|RETURNS: [Matrix]({{site.url}}/Pages/StereoKit/Matrix.html)|A Matrix that will rotate by the provided pitch, yaw and roll.|
